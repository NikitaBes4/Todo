          ...
          <div class="divide-y divide-gray-200">
            <div class="py-8 text-base leading-6 space-y-4 text-gray-200 sm:text-lg sm:leading-7">
              <div class="relative">
                ...
                <label for="email" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Адресс электронной почты</label>
              </div>
              <div class="relative">
                <input on:change={handleChange} 
                on:blur={handleChange} 
              ...
              <div class="relative"> 
                ...
                disabled={!$isValid}
                class ="bg-amber-500 text-white rounded-md px-2 py-1">Подтвердить</button>
              </div>
            </div>
          </div>
